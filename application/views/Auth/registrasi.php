                ...
                <div class="row">
                    <div class="col-12">
                                ...
                                <div class="card card-primary">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="">
                                            ...
                                            <a href="<?= base_url('Auth') ?>" class="btn btn-transparent text-warning btn-lg btn-block">Kembali ke login</a>
                                        </form>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="simple-footer">
                            Copyright &copy;
                            <a href="https://instagram.com/andikha.dian16" class="text-warning">Andikha Dian Nugraha</a>
                            2020
                        </div>
                    </div>
                </div>
