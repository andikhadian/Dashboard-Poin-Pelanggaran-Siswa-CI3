 ...
 */
define('PDF_HEADER_LOGO', 'logo_pp.png');
 ...
 * Header title.
 */
define('PDF_HEADER_TITLE', 'SMK Prestasi Prima');

/**
 * Header description string.
 */
define('PDF_HEADER_STRING', "Poin Pelanggaran Siswa\npoinpelanggaranpp@gmail.com");
